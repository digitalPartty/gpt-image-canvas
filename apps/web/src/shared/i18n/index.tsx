...
const zhMessages = {
  ...
  homeDeck: "把提示词、参考图、生成历史和视觉比较收束到一张创作画布里。",
  homeEntryAria: "进入方式",
...
const enMessages: I18nMessages = {
  ...
  homeDeck: "Bring prompts, references, generation history, and visual comparison into one creative canvas.",
  homeEntryAria: "Entry options",
  homeGallery: "Open Gallery",
  homeKicker: "AI Creation Tool",
